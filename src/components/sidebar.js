...
function Sidebar ({ isVisible, toggleSidebar }){
  ...
  return (
    <motion.div
      ...
      className="fixed top-0 right-0 h-full w-80 bg-white p-5 shadow-lg z-40 overflow-y-auto no-scrollbar"
    >
    
    <div className="flex flex-col justify-start items-center flex-nowrap fixed bg-white h-screen w-72 z-[1500] text-black text-md text-sm font-bold py-20 space-y-2 overflow-y-auto no-scrollbar">
    ...
    <div className="flex justify-evenly items-center py-2 w-60 border-y-2 border-gray-800 text-black hover:text-blue-900 hover:border-blue-900">
    <span className="inline h-4 w-4">  </span>
    <Typography variant="subtitle6" className="relative right-6 font-bold hover:shadow-xl transition-transform duration-200 ease-in-out mx-4 banner-text uppercase"> high court calendar </Typography>
    </div>
    </Link>
    ...
    <div className="flex justify-evenly items-center py-2 w-60 border-y-2 border-gray-800 text-black hover:text-blue-900 hover:border-blue-900">
    <span className="inline h-4 w-4">  </span>
    <Typography variant="subtitle6" className="relative right-6 font-bold hover:shadow-xl transition-transform duration-200 ease-in-out mx-4 banner-text uppercase"> Sitting Judges </Typography>
    </div>
    </Link>
    ...
    <div className="flex justify-evenly items-center py-2 w-60 border-y-2 border-gray-800 text-black hover:text-blue-900 hover:border-blue-900">
    <span className="inline h-4 w-4">  </span>
    <Typography variant="subtitle6" className="relative right-6 font-bold hover:shadow-xl transition-transform duration-200 ease-in-out mx-4 banner-text uppercase"> announcements </Typography>
    </div>
    </Link>
