...
import { FaUser, FaUsers, FaMapMarkerAlt } from 'react-icons/fa'; // Importing the map link icon
          ...
          >
            ...
            >
              <div className="flex flex-col gap-2">
                ...
                <Link href={`https://${event.link}`} className="text-sm text-gray-400">
                  <FiLink className="inline text-gray-400" /> {event.link}
                </Link>
